...
window.KATEMBO = (function () {
  ...
  var journeys = [
    ...
    },
    {
      ...
      overview: 'The definitive Tanzanian safari. Begin among the ancient baobabs and elephant herds of Tarangire, continue through the crater and Serengeti, and end with the white sand and turquoise waters of Zanzibar. A complete cross-section of the country’s greatest landscapes.',
  ...
  var experiences = [
    ...
    },
    {
      ...
      bestFor: 'Seeing a large region in a shorter, more spectacular way.',
    ...
    },
    {
      ...
      highlights: ['An exclusive vehicle for your party', 'A single dedicated professional guide', 'Flexible timing and route by day', 'Bush picnic or sundowner'],
    ...
    },
    {
      ...
      type: 'Specialist',
      image: IMG.migration,
      description: 'Considered light, patient positioning and the wild in perfect frame.',
      overview: 'A safari arranged around light and framing. Accommodation chosen for position, drives timed for golden hour, and the patience to wait for the image rather than chase it. Complete photography support, without ever making the trip feel like a class.',
      highlights: ['Positioning timed to the light', 'Vantage points chosen for the frame', 'Camera support and handling assistance', 'Portfolio-grade light across the journey'],
  ...
  var stayTypes = [
    ...
    { slug: 'lodges', title: 'Lodges', blurb: 'Refined lodges built from local stone and timber, set for views that last from breakfast to sundown.' },
